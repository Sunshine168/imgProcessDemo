(function() {
    var Main = {
        ...
        showModel: function() {
            ...
            var effectModel = '<li class="e_item"><div class="imgWrapper"><img src="/static/style/image/demo/{pic}.png" alt="" />{effect}</div></li>';
            var html = '<li class="e_item"><div class="imgWrapper"><img src="/static/style/image/demo/e1.jpg" alt="" />原图</div></li>';
